...
my.theme2 <- theme(axis.text.x = element_text(size = 15, face = "bold", family = "serif"),
                   axis.text.y = element_text(size = 15, face = "bold", family = "serif"),
                   axis.title.x = element_text(size = 18, face = "bold", family = "serif"),
                   axis.title.y = element_text(size = 18, face = "bold", family = "serif"),
                   axis.line.x = element_line(colour = 'black', size=0.5, linetype='solid'),
                   axis.line.y = element_line(colour = 'black', size=0.5, linetype='solid'),
                   legend.text = element_text(size = 10, face = "bold", family = "serif"),
                   legend.key = element_blank(),
...
my.theme3 <- theme(axis.text.x = element_blank(),
...
my.theme.composition <- theme(axis.text.x = element_blank(),
      ...
      legend.title = element_text(size = 10, face="bold", family = "serif"),
      legend.position = "right", 
      strip.text.x = element_text(size = 15, face = "bold", family = "serif", vjust=2),
...
ANCOM.main = function(OTUdat,Vardat,
  ...
  final_results=list(W_frame,zero.plot, W.detected)
  names(final_results)=c("W.taxa","PLot.zeroes", "W.detected")
